...
public class DisplayTextViews extends LinearLayout {
    ...
    public DisplayTextViews(Context context, AttributeSet attrs){
        ...
        orientation=typedArray.getString(R.styleable.BannerAdControl_orientation);
        label=typedArray.getString(R.styleable.BannerAdControl_label);
        value=typedArray.getString(R.styleable.BannerAdControl_value);
        labelColor=typedArray.getColor(R.styleable.BannerAdControl_labelColor,0);
        valueColor=typedArray.getColor(R.styleable.BannerAdControl_valueColor,0);
        initView();
